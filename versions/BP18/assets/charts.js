(function() {
  var weeklyData = [
  {
    ...
    "type_distribution": [
      ...
      },
      {
        ...
        "image": "../../assets/cards/ECP02-055.png"
      },
      {
        "name": "梦魇｜妖怪梦",
        "value": 2,
      ...
      {
        "name": "偶像大师｜〔ミラクルホーリーナイト〕イヴ・サンタクロース型",
        "value": 1,
        "link": "decktypes/decktype-40eeb76f200e.html",
        "image": "../../assets/cards/ECP02-055.png"
      },
      {
        "name": "巫师｜アシッドゴーレム型",
    ...
    "scope_summary": "截至本次周一早上9点的最后一次数据统计，总数据共收录303场有效赛事、2967套有排名记录的卡组，其中Top8卡组2895套、冠军卡组386套。从Top8职业分布看，梦魇996套（34.4%）、龙族579套（20.0%）构成本范围的主要出场面，冠军侧则以梦魇138套（35.8%）、精灵95套（24.6%）表现最突出。卡组类型方面，梦魇「nc梦」392套（13.5%，最好4/248）、精灵「连击妖」390套（13.5%，最好1/248）、梦魇「机械梦」354套（12.2%，最好1/248）位居前列，说明环境核心集中在少数成熟体系。单套成绩最佳的是梦魇「机械梦」，由ヒスイ使用，成绩为1/248，成绩系数0.0040。整体来看，前10%成绩卡组共有785套，占全部记录26.5%；后续应继续跟踪头部卡组占比变化，以及中小众类型是否能稳定进入高顺位。"
  },
  {
    "key": "2026-W05",
  ...
  },
  {
    ...
    "scope_summary": "本周在周一早上9点完成最后一次数据统计后，2026 第3周（2026/01/12-2026/01/18）共收录44场有效赛事、421套有排名记录的卡组，其中Top8卡组421套、冠军卡组56套。从Top8职业分布看，梦魇136套（32.3%）、精灵88套（20.9%）构成本范围的主要出场面，冠军侧则以梦魇19套（33.9%）、精灵15套（26.8%）表现最突出。卡组类型方面，精灵「连击妖」74套（17.6%，最好1/23）、梦魇「nc梦」71套（16.9%，最好1/26）、龙族「大哥龙」47套（11.2%，最好1/24）位居前列，说明环境核心集中在少数成熟体系。单套成绩最佳的是梦魇「nc梦」，由NG201使用，成绩为1/26，成绩系数0.0385。整体来看，前10%成绩卡组共有97套，占全部记录23.0%；后续应继续跟踪头部卡组占比变化，以及中小众类型是否能稳定进入高顺位。"
  },
  {
    "key": "2026-W02",
