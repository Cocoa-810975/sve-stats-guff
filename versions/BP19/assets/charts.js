(function() {
  ...
  },
  {
    ...
    "scope_summary": "本周在周一早上9点完成最后一次数据统计后，2026 第13周（2026/03/23-2026/03/29）共收录32场有效赛事、303套有排名记录的卡组，其中Top8卡组303套、冠军卡组42套。从Top8职业分布看，梦魇80套（26.4%）、皇家护卫67套（22.1%）构成本范围的主要出场面，冠军侧则以梦魇13套（31.0%）、皇家护卫9套（21.4%）表现最突出。卡组类型方面，皇家护卫「财宝皇」41套（13.5%，最好1/34）、梦魇「永火梦」35套（11.6%，最好2/34）、梦魇「真红梦」23套（7.6%，最好1/22）位居前列，说明环境核心集中在少数成熟体系。单套成绩最佳的是皇家护卫「财宝皇」，由piro使用，成绩为1/34，成绩系数0.0294。整体来看，前10%成绩卡组共有84套，占全部记录27.7%；后续应继续跟踪头部卡组占比变化，以及中小众类型是否能稳定进入高顺位。"
  }
];
  var scopeData = {
  "total": {
